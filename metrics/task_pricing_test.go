...
func TestCalibrationMetricsKeepBaseUnits(t *testing.T) {
	...
	SetTaskPricingCalibration("sd", "sd-model", "fp16", "auto", 0, 24, 0.00004, [6]float64{})
	SetTaskPricingCalibration("llm", "llm-model", "", "bfloat16", 4, 24, 0, [6]float64{12, 0.002, 0.3, 120, 10, 5})
	SetGPUExecutionCalibration("llm", "A100", 40, "llm-model", "", "bfloat16", 4, 16, 24, 0.00003, [6]float64{10, 0.001, 0.2, 100, 8, 4}, 9)
