...
func TestMetricsEndpointServesRegisteredMetrics(t *testing.T) {
	...
	TasksAborted.WithLabelValues("timeout", "undelivered").Inc()
	TaskQueueWaitSeconds.WithLabelValues("sd").Observe(1.5)
	TaskExecutionSeconds.WithLabelValues("sd").Observe(60)
